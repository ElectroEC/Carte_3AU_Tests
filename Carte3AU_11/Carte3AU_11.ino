/*
  Code 11: Test Rotary encoder with switch
*/
...
const int maximumEncoderValue = 200;
...
void setup() {
  ...
  // we give the encoder a max value of 200, always minumum of 0.
